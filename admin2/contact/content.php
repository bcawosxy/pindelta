...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<a class="btn btn-app" href="<?php echo URL_ADMIN2_ROOT.'contact' ?>">
			<i class="fa fa-angle-double-left"></i> 上一頁
		</a>
		<a class="btn btn-app " id="archive">
			<i class="fa fa-envelope"></i> 封裝(Archive)
		</a>
...
$(function () {
	$('#archive').on('click', function(){
		$.post('<?php echo ajax_url(URL_ADMIN2_AJAX,P_CLASS,'archive') ?>' , {
