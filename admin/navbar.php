<aside class="main-sidebar">
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li>
				<a href="<?php echo URL_ADMIN2_ROOT.'categoryarea'; ?>"><i class="fa fa-list"></i> <span>產品類別管理</span></a>
			</li>
			<li>
				<a href="<?php echo URL_ADMIN2_ROOT.'category'; ?>"><i class="fa fa-list-ul"></i> <span>產品項目管理</span></a>
			</li>
			<li>
				<a href="<?php echo URL_ADMIN2_ROOT.'product'; ?>"><i class="fa fa-heart"></i> <span>產品管理</span></a>
			</li>
		</ul>
		<ul class="sidebar-menu">
		...
		<ul class="sidebar-menu">
			...
			<li>
				<a href="<?php echo URL_ADMIN2_ROOT.'index/logout.php' ?>"><i class="fa fa-sign-out"></i> <span>登出</span></a>
			</li>
		</ul>
	</section>
</aside>