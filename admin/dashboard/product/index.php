...
<head>
	...
	<script src="<?php echo URL_LIB_ROOT.'js/jquery_file_upload/vendor/jquery.ui.widget.js';?>"></script>
	<script src="<?php echo URL_LIB_ROOT.'js/jquery_file_upload/jquery.iframe-transport.js'; ?>"></script>
